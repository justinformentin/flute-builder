...
import { buttonClass, Field, inputClass, NumberInput, Section } from '../components/FormControls'
  ...
  return (
    <main className="grid min-h-[calc(100vh-70px)] grid-cols-1 xl:grid-cols-[410px_minmax(700px,1fr)]">
      ...
      <article className="min-w-0 p-4 md:p-8">
        ...
        <DesignResults design={design} result={result} rootHz={rootHz} boreMm={boreMm} noteLabels={noteLabels} />
      </article>
    </main>
  )
}
