...
export function DesignResults({ design, result, rootHz, boreMm, noteLabels }: { design: DesignState; result: FluteResult; rootHz: number; boreMm: number; noteLabels: string[] }) {
  return <><Summary design={design} result={result} rootHz={rootHz} boreMm={boreMm} /><MeasurementTable design={design} result={result} noteLabels={noteLabels} /></>
}
